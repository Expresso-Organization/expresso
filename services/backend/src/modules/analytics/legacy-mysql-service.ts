import { type InsightDraft, AnalyticsError, validateInsightDraft } from "./public.js";
...
export class AnalyticsService {
  ...
  readonly #entitlements: EntitlementApi | null;
  ...
  constructor(
    ...
    options: {
      ...
      entitlements?: EntitlementApi | null;
    } = {},
  ) {
    this.#sql = sql;
