...
글자 · 강조 색으로 이름을 조판한 포스터 썸네일을 표시한다. 참고 디자인은 포스터
오른쪽 아래에 출처 회사 마크를 함께 둔다 — 카탈로그 항목은 마크 이름만 주고
그림은 화면이 가진다. 아는 회사가 아니면 마크 없이 그린다. 목록 응답에는 문서를
...
| 2026-09-01 | 참고 디자인 카드에 출처 회사 마크 표시 |
