...
export async function careerViewConfigurationSteps(): Promise<MongoMigrationStep[]> {
  return [{ id: "career_views:configuration_fields", async run(db: Db) {
    ...
    Object.assign(properties, { configuration: { bsonType: "object" }, version: { bsonType: ["int", "long", "double"], minimum: 1, multipleOf: 1 }, updatedAt: { bsonType: "date" } });
