    ...
    profiles = [
        {
            ...
            "events": [
                _event(1, "education_history", ["행정학 계열 학사 과정을 2018-03에 시작해 2022-02에 마쳤다"], ["institution", "startMonth"], survey=["yp2021:v1:education_completion"], synthetic=["institution"]),
                ...
                _event(3, "project", ["오염도를 측정해 웹사이트에 게시하는 프로젝트에서 업무 분담과 협약을 조율했다", "프로젝트를 끝까지 마무리했다"], ["role"], narrative=["aih-71592-ckmk_d_ps_m_n_308337"]),
                ...
                _event(5, "experience", ["공공 프로젝트 운영 실무를 4년간 담당했다", "기획안 정리, 참여자 조율, 결과 보고를 맡았다"], ["role"], survey=["yp2021:v1:first_job_duration", "yp2021:v1:occupation_industry_transition"], synthetic=["organization"]),
            ],
        },
        {
            ...
            "events": [
                _event(1, "education_history", ["정보통신 계열 학사 과정을 2017-03에 시작해 2021-02에 마쳤다", "수업에서 데이터베이스 기초를 배웠다"], ["program", "startMonth"], survey=["yp2021:v1:major_to_first_job"], synthetic=["institution"]),
                _event(2, "certification_award", ["2021-06에 데이터 분석 기초 자격을 취득했다"], ["issuedMonth"], survey=["yp2021:v1:qualification_after_education"], synthetic=["issuer", "certificate_name"]),
                ...
                _event(4, "project", ["Python으로 공공데이터의 형식을 통일하고 결측값 처리 기준을 문서화했다", "정리된 데이터를 팀 분석에 사용할 수 있게 전달했다"], ["technologies"], narrative=["aih-71592-ckmk_d_ps_f_e_287617"], synthetic=["dataset_name"]),
                ...
                _event(6, "experience", ["2021-09부터 데이터 운영 보조 업무를 담당했다", "정기 적재 결과와 오류 목록을 확인했다"], ["role"], survey=["yp2021:v1:first_job_start", "yp2021:v1:occupation_industry_transition"], synthetic=["organization"]),
        ...
        },
        {
            ...
            "events": [
                _event(1, "education_history", ["기계공학 계열 학사 과정을 2013-03에 시작해 2017-02에 마쳤다", "실험과 기초 프로그래밍 수업을 이수했다"], ["program"], survey=["yp2021:v1:major_to_first_job"], synthetic=["institution"]),
                ...
                _event(6, "certification_award", ["2018-05에 데이터 처리 관련 자격을 취득했다"], ["issuedMonth"], survey=["yp2021:v1:qualification_timing"], synthetic=["issuer", "certificate_name"]),
                _event(7, "experience", ["2018-07부터 제조 분야 연구개발 보조 업무를 담당했다", "실험 데이터 정리와 장비 상태 기록을 맡았다"], ["role"], survey=["yp2021:v1:first_job_start", "yp2021:v1:industry_occupation_pair"], synthetic=["organization"]),
